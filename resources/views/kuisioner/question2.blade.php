...
<body class="min-h-screen bg-gray-400">
    ...
    <div class="flex flex-col gap-y-5 items-center p-5">
        ...
        <form action="{{ route('user.kuisionerSessionTwoStore') }}" method="post" class="bg-white rounded-xl p-5 w-1/2 mx-auto flex flex-col gap-y-5">
            @csrf
            ...
            <div class="flex justify-center gap-x-5">
                <a href="{{ route('user.kuisionerSessionOne') }}" class="btn w-1/2 bg-white border-[#0F4B93] text-[#0F4B93]">Sebelumnya</a>
