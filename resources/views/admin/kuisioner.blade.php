                ...
                <div class="flex gap-x-2 items-center mb-5">
                    ...
                    <div class="modal" role="dialog">
                        <div class="modal-box bg-white">
                            ...
                            <form action="{{ route('admin.kuisionerTypeEdit', $kuisionerData['kuisioner1']->first()->questionType) }}" method="post">
                                @csrf
                                @method('patch')
                ...
                <div class="flex gap-x-2 items-center mb-5">
                    ...
                    <div class="modal" role="dialog">
                        <div class="modal-box bg-white">
                            ...
                            <form action="{{ route('admin.kuisionerTypeEdit', $kuisionerData['kuisioner2']->first()->questionType) }}" method="post">
                                @csrf
                                @method('patch')
                                <input type="text" placeholder="Type here" name="questionType"
