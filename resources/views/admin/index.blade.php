        ...
        <div class="mt-4 flex gap-x-5">
            <div class="w-2/12">
                <div class="bg-[#3257C0] p-4 text-white rounded-lg">
                    ...
                    <button
                        class="btn btn-primary flex items-center gap-x-2 bg-[#133256] border-white px-5 py-2 w-full rounded-lg mt-4">
                    ...
                    <button
                        class="btn btn-primary flex items-center gap-x-2 bg-[#F9432A] border-white px-5 py-2 mt-3 w-full rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path fill-rule="evenodd"
                                d="M8.25 6.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM15.75 9.75a3 3 0 1 1 6 0 3 3 0 0 1-6 0ZM2.25 9.75a3 3 0 1 1 6 0 3 3 0 0 1-6 0ZM6.31 15.117A6.745 6.745 0 0 1 12 12a6.745 6.745 0 0 1 6.709 7.498.75.75 0 0 1-.372.568A12.696 12.696 0 0 1 12 21.75c-2.305 0-4.47-.612-6.337-1.684a.75.75 0 0 1-.372-.568 6.787 6.787 0 0 1 1.019-4.38Z"
                                clip-rule="evenodd" />
